...
4121	Q5JTZ9;P123A4	AARS2	Alanine--tRNA ligase;mitochondrial		1	16	22.4	8	4	985	107.34	0.024570714	0.016213149	28.21029836	42.75216253
	...
	It("should read gene names with turnover rates", func() {
		...
		data := analysis{
			parameters: parameters{
				turnoverFile: "test/turnover.txt",
			},
		...
		Expect(readTurnoverRates(data)).To(Equal(expected))
	})
})
